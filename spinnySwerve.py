...
class SwerveBot(sea.GeneratorBot):
    ...
    def autonomous(self):
        ...
        yield from self.pathFollower.followPathData(data, math.radians(5))
    ...
    def teleop(self):
        ...
        while True:
            ...
            angularOffset = abs(self.pathFollower.robotAngle - math.atan2(self.joystick.getRawAxis(3), self.joystick.getRawAxis(4)))
